...
async function run() {
  ...
  const orgsMap = reqsToMap(results[0]);
  addInOrgsMap(orgsMap, results[1], "analytics");
  addInOrgsMap(orgsMap, results[2], "buhForms");
  render(orgsMap, orgOgrns);
}

// Uncaught (in promise) TypeError: can't access property Symbol.iterator, additionalInfo is undefined
//     addInOrgsMap http://localhost:3000/focus.js:39
//     run http://localhost:3000/focus.js:12
//     async* http://localhost:3000/focus.js:17
